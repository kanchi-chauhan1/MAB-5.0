(function () {
    ...
    function detailedMessage() {
        var heading=document.querySelector('.bodyContainer>div h2')
        ...
        heading.innerHTML="Please provide the details of the <span>account holder</span>";
        heading.insertAdjacentHTML('afterend', detailMsgHtml);
    }
